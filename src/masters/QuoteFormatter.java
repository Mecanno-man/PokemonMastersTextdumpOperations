        ...
        for (String key : dump.keySet()) {
            if (key.startsWith("\r\nch0")) {
                ...
                if (!key.contains("salon")) {
                    ...
                    extractQuote("0101_0701", "Zufällig beim Login",
                            map, writer);
                    ...
                    PrintWriter lounge = new PrintWriter(
                            "characterLoungeQuotes/"
                            + name + charaversion + ".txt");
                    ...
                    extractQuote("8201_2202",
                            "Interagieren ab Level 10", map, lounge);
                    extractQuote("8201_2203",
                            "Interagieren ab Level 30", map, lounge);
                    extractQuote("8201_2302",
                            "Bei Übergabe eines Geschenks (Zufall)",
                            map, lounge);
                    extractQuote("8201_2301",
                            "Bei Übergabe eines Geschenks (Zufall)",
                            map, lounge);
                    extractQuote("8201_2402",
                            "Ende einer Interaktion (Zufall)", map, lounge);
                    extractQuote("8201_2401",
                            "Ende einer Interaktion (Zufall)", map, lounge);
                    extractQuote("8001_0701",
                            "Plaudern", map, lounge);
                    extractQuote("8002_0701",
                            "Plaudern nach Abschluss der ersten Erinnerungsepisode",
                            map, lounge);
                    extractQuote("8003_0701",
